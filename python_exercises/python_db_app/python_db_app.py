...
def main():
    ...
    #conn = psycopg2.connect(database="exercises",host="localhost",user="postgres",password="1234",port="5432")
    # sudo docker run --network python-db-shared --mount type=bind,source="$(pwd)"/data,target=/app/data python-db-docker "172.19.0.2" "5432" "postgres" "1234" "exercises" "cd.members" "data/output"
